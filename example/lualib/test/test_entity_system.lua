...
local Component = require('entitas.Component')
...
local Position = Component("Position", "x", "y", "z")
local Movable = Component("Movable", "speed")
local Person = Component("Person", "name","age")
local Counter = Component("Counter", "num")
local PlayerData = Component("PlayerData", "name")
...
GLOBAL.test_matches =  function()
    local CompA = Component('CompA', '')
    local CompB = Component('CompB', '')
    local CompC = Component('CompC', '')
    local CompD = Component('CompD', '')
    local CompE = Component('CompE', '')
    local CompF = Component('CompF', '')
