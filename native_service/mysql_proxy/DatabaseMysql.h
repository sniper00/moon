...
public:
	...
	void Initialize(const std::string& host,int port, const std::string& user, const std::string& password, const std::string& database);
	...
	*/
	...
	void QueryJson(const char* sql, moon::buffer& buf);
